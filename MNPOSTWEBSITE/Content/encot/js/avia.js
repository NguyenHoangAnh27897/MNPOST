        ...
        var header = $('#header'),
            ...
            create_list = function (items, append_to) {
                ...
                items.each(function () {
                    ...
                    link = current.find('>a').clone().attr('style', '');
                            ...
                            megaitems.each(function (iteration) {
                                ...
                                if (mega_title.length && mega_title.text() != "") {
                                    ...
                                    if (cloneFirst && (mega_link.length && mega_link.get(0).hash != '#' && mega_link.attr('href') != '#')) {
                                        new_li.clone().addClass('av-cloned-title').prependTo(new_ul);
                                    }
...
// requestAnimationFrame polyfill by Erik MĂ¶ller. fixes from Paul Irish and Tino Zijdel. can be removed if IE9 is no longer supported or all parallax scripts are gone MIT license
